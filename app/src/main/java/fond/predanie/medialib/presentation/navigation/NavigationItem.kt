package fund.predanie.medialib.presentation.navigation
...
sealed class NavigationItem(var route: String, var icon: Int, var title: String) {
    ...
    object Post : NavigationItem("PostScreen/{postId}", R.drawable.ic_action_user, "Пост блога")
    ...
    object Playlist : NavigationItem("PlaylistScreen", R.drawable.predanie, "Плейлист")
}